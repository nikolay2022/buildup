...
class BuildNotifierImpl : BuildNotifier {
    ...
    override operator fun invoke(buildStatusModel: BuildStatusModel, projectName: String) {
//        CoroutineScope(Dispatchers.IO + Job()).launch {
            notify(buildStatusModel, projectName)
//        }
    }

    private fun notify(buildStatusModel: BuildStatusModel, projectName: String) {
